...
public class OrderController {
	...
	public ModelAndView cancel(ModelMap model, @PathVariable("order-id") int id) {
		...
		sendMailAction(oReal, "Bạn đã bị huỷ 1 đơn hàng từ TechPoly Shop!",
	...
	public ModelAndView confirm(ModelMap model, @PathVariable("order-id") int id) {
		...
		sendMailAction(oReal, "Bạn có 1 đơn hàng ở TechPoly Shop đã được xác nhận!",
	...
	public ModelAndView delivered(ModelMap model, @PathVariable("order-id") int id) {
		...
		sendMailAction(oReal, "Bạn có 1 đơn hàng ở TechPoly Shop đã thanh toán thành công!",
				"Chúng tôi cám ơn bạn vì đã ủng hộ TechPoly Shop!", "Thông báo thanh toán thành công!");
